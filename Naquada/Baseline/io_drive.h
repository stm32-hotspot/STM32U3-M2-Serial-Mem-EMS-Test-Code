/**
  ******************************************************************************
  * @file    io_drive.h (Alternate way to implement IO APIs to make things more intuitive)
  * @author  S.Ma
  * @brief   ...
  * 
  ******************************************************************************
...
uint32_t PadSignal2PPP(IO_Pad_t* pPad); // must be alternate function mode to get a valid PPP, otherwise 0 as error.
