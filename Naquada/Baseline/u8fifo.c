/**
  ...
  * @author  S.Ma
  * @brief   This is a byte SW FIFO with statistic to tune the buffer size. Has disable interrupt code segments for it.
  *          Triggers on FIFO gets empty/no longer empty, full/no longer full to manage interrupt enable/disable
  *          You can flow data between main loop and interrupts, or between interrupt, such as between 2 USART with different baud rates.
  *          There is another type of FIFO which manages 32 bit pointers to make a spooler, dodging complex coding when one peripheral is shared across threads.
  * 
  ******************************************************************************
  * @attention
  *
